...
export async function recalculateStandings(
  ...
  try {
    ...
    // finished their group phase. Without this an admin who flipped a
    // tournament to bracketMode='divisions' AFTER groups closed had no
    // way to regenerate Oro/Plata — the auto-gen only fires on match
    // mutations, and there are no more matches to mutate.
    try {
      await fixtureGenerator.autoGenerateDivisionBrackets(id);
