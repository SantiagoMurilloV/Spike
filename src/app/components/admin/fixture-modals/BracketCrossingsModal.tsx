...
/**
 * Post-group crossings builder — the admin decides which group-placement
 * placeholders meet each other in the first round of the knockout
 * bracket. Supports multi-category tournaments (group names encode the
 * category as a `Category|Letter` prefix, parsed here via phase helpers).
 *
 * The bracket size is derived from `groups × classifiersPerGroup` rounded
 * up to the next power of two — extra slots are automatically tagged as
 * byes.
 */
